# This is the fourth of four scripts for project 1 of the Coursera "Exploratory Data Analysis" class.
...
# itself. This script can be run by typing 'source("plot4.R")' into the R console
#
# The dataset URL is: 
#   https://d396qusza40orc.cloudfront.net/exdata_data_household_power_consumption.zip
#
# After reading the data, this script generates a set of four sub plots showing
# various aspects of the the dataseta for the dates Feb 1, 2007 and Feb 2, 2007
#
# The result is stored in a png image called "plot4.png".
...
png("plot4.png")  # The defaults for png are just right in this case.

# This will be a 2x2 set of plots in column order (because the first two plots
# are (mostly) copies of earliers plots and will appear in the first column)
par(mfcol=c(2,2))

# This is a copy of plot2:
    # The data as lines, with no x-axis and no x-label
    plot(powerData$Global_active_power,
         type="l",
         ylab="Global Active Power (kilowatts)",
         xaxt="n",
         xlab="")
    # Add the X-axis with day names as the labels at the beginning, middle and end.
    axis(1,at=c(0,1440,2880),labels=c("Thu","Fri","Sat"))

# This is a copy of plot3, except the legend doesn't have a box around it this time:
...
# A new graph of Voltage (simliar to plot2)
    # The data as lines, with no x-axis and no x-label
...
# Another new graph of Global_reactive_power (also simliar to plot 2, and the plot above)
    # The data as lines, with no x-axis and no x-label
