# This is the second of four scripts for project 1 of the Coursera "Exploratory Data Analysis" class.
...
# itself. This script can be run by typing 'source("plot2.R")' into the R console
#
# The dataset URL is: 
#   https://d396qusza40orc.cloudfront.net/exdata_data_household_power_consumption.zip
#
# After reading the data, this script generates a line graph of
# Global Active Power for the dates Feb 1, 2007 and Feb 2, 2007
#
# The result is stored in a png image called "plot2.png".
...
png("plot2.png")  # The defaults for png are just right in this case.
